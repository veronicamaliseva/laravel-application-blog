    ...
    <div class="row">
      <div class="col header">
        ...
        <p>The main purpose of the blog is to inspire but also promote the world’s best creative <br>
          ...
          <a href="#" class="btn mt-4">START NOW</a>
      </div>
    </div>
  </div>
</section>
...
<?php echo $__env->make('site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\_blog\resources\views/site/pages/homepage.blade.php ENDPATH**/ ?>